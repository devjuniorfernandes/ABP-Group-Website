    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 max-w-[1200px]">
            <div class="mb-12 flex flex-col md:flex-row md:justify-between md:items-end gap-6">
                ...
                <a href="{{ route('projects') }}" class="inline-flex items-center gap-2 text-[#dd5209] hover:opacity-80 font-primary font-bold text-sm transition-all duration-300 group">
                    Ver mais 
