    ...
    <section class="section">
        <div class="container mx-auto px-6 max-w-[1200px]">
            ...
            <div class="mb-10 text-left">
                <span class="font-primary text-xs font-bold uppercase tracking-widest text-[#e51718] mb-2 block">Realizações do Grupo</span>
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
                ...
                <div class="flex flex-wrap gap-3" id="project-filters">
                    <button data-filter="Todos" class="filter-btn px-6 py-2.5 bg-[#e51718] text-white font-primary font-medium text-sm rounded-full transition-colors hover:bg-red-700 shadow-sm">Todos</button>
                    <button data-filter="PantherBUILD" class="filter-btn px-6 py-2.5 bg-gray-100 text-gray-600 font-primary font-medium text-sm rounded-full transition-colors hover:bg-gray-200">PantherBUILD</button>
                    <button data-filter="PantherMAT" class="filter-btn px-6 py-2.5 bg-gray-100 text-gray-600 font-primary font-medium text-sm rounded-full transition-colors hover:bg-gray-200">PantherMAT</button>
                    <button data-filter="PantherOIL" class="filter-btn px-6 py-2.5 bg-gray-100 text-gray-600 font-primary font-medium text-sm rounded-full transition-colors hover:bg-gray-200">PantherOIL</button>
                    <button data-filter="Enviro.ao" class="filter-btn px-6 py-2.5 bg-[#99c24d]/20 text-[#3b6b35] font-primary font-bold text-sm rounded-full transition-colors hover:bg-[#99c24d]/30">Enviro.ao</button>
                </div>

                <!-- Search Bar -->
                <div class="relative w-full lg:w-80">
                    <input type="text" id="project-search" placeholder="Pesquisar projeto..." class="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-full font-secondary text-sm focus:outline-none focus:border-[#e51718] focus:ring-1 focus:ring-[#e51718] transition-all shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="projects-grid">
                ...
                <x-project-card title="Centro Logístico de Talatona - Armazém D07"
                    ...
                    image="{{ asset('images/panther-build-hero.png') }}" category="PantherBUILD / PantherMAT" link="{{ route('project.details') }}" />
                ...
                <x-project-card title="Auditoria de Impacto Ambiental no Soyo"
                    ...
                    image="{{ asset('images/enviro-hero.png') }}" category="Enviro.ao" link="{{ route('project.details') }}" />
                ...
                <x-project-card title="Apoio Técnico a Gasodutos de Exploração"
                    ...
                    image="{{ asset('images/panther-oil-hero.png') }}" category="PantherOIL" link="{{ route('project.details') }}" />
                ...
                <x-project-card title="Climatização Central de Edifício de Escritórios em Luanda"
                    ...
                    image="{{ asset('images/panther-mat-hero.png') }}" category="PantherMAT" link="{{ route('project.details') }}" />
                ...
                <x-project-card title="Construção de Pavilhão Industrial em Viana"
                    ...
                    image="{{ asset('images/panther-build-hero.png') }}" category="PantherBUILD" link="{{ route('project.details') }}" />
            ...
            <div class="mt-20 flex justify-center">
                <nav class="flex items-center gap-2">
                    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full border border-gray-200 text-gray-400 hover:text-[#e51718] hover:border-[#e51718] transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                    </a>
                    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full bg-[#e51718] text-white font-primary font-bold text-sm shadow-md">1</a>
                    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full border border-gray-200 text-gray-600 font-primary font-bold text-sm hover:border-[#e51718] hover:text-[#e51718] transition-colors">2</a>
                    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full border border-gray-200 text-gray-600 font-primary font-bold text-sm hover:border-[#e51718] hover:text-[#e51718] transition-colors">3</a>
                    <span class="w-10 h-10 flex items-center justify-center text-gray-400">...</span>
                    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full border border-gray-200 text-gray-600 font-primary font-bold text-sm hover:border-[#e51718] hover:text-[#e51718] transition-colors">8</a>
                    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full border border-gray-200 text-gray-400 hover:text-[#e51718] hover:border-[#e51718] transition-colors">
