    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-[1200px]">
            <div class="mb-12 flex flex-col md:flex-row md:justify-between md:items-end gap-6">
                <div>
                    <span class="font-primary text-sm font-bold uppercase tracking-widest text-gray-400 mb-2 block">NOSSOS PROJECTOS</span>
                ...
                <a href="#" class="inline-flex items-center gap-2 text-[#3b6b35] hover:opacity-80 font-primary font-bold text-sm transition-all duration-300 group">
                    Ver mais 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="relative aspect-square group overflow-hidden cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Project 1" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    <!-- Dark Gradient to make text readable -->
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-100 transition-opacity duration-300"></div>
                    <!-- Hover Green Overlay -->
                    <div class="absolute inset-0 bg-[#9DBD4D]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                ...
                <!-- Card 2 -->
                <div class="relative aspect-square group overflow-hidden cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1582967265696-67a840e69123?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Project 2" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-100 transition-opacity duration-300"></div>
                    <!-- Hover Green Overlay -->
                    <div class="absolute inset-0 bg-[#9DBD4D]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                ...
                <!-- Card 3 -->
                <div class="relative aspect-square group overflow-hidden cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Project 3" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-100 transition-opacity duration-300"></div>
                    <!-- Hover Green Overlay -->
                    <div class="absolute inset-0 bg-[#9DBD4D]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
        ...
        <div class="container mx-auto px-6 max-w-[1200px]">
            <div class="grid grid-cols-1 md:grid-cols-2 h-auto">
                ...
                <div class="bg-[#9DBD4D] p-12 md:p-16 lg:p-20 flex flex-col justify-center">
                    <h3 class="font-primary text-xl font-bold text-white mb-6 uppercase tracking-wider">Lorem Ipsum</h3>
                ...
                <div class="h-[400px] md:h-auto relative">
                    <img src="https://images.unsplash.com/photo-1557050543-4d5f4e07ef46?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Elephant" class="absolute inset-0 w-full h-full object-cover" />
                </div>
                
                <!-- Bottom Left: Image (Volunteers/Planting) -->
                <div class="h-[400px] md:h-auto relative">
                    <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" alt="Volunteers" class="absolute inset-0 w-full h-full object-cover" />
                </div>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-[1200px]">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-16">
                ...
                <a href="#" class="inline-flex items-center gap-2 text-[#3b6b35] hover:opacity-80 font-primary text-lg transition-all duration-300 group">
                    Ver mais 
                    <svg class="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"></path></svg>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div class="border-l-2 border-gray-200 pl-6 group cursor-pointer">
                    <h4 class="font-primary text-[22px] font-bold text-gray-400 group-hover:text-[#3b6b35] transition-colors duration-300 mb-4 leading-tight">
                    ...
                    <p class="font-secondary text-base text-gray-400 leading-relaxed mb-6 pr-4">
                        Partilhamos os acontecimentos, projectos e conquistas que demonstram a evolução do grupo e o impacto das nossas actividades nos sectores onde actuamos.
                    </p>
    ...
    <footer class="bg-[#3b6b35] text-white border-t border-white/20 font-secondary pt-16 pb-8">
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 max-w-[1200px]">
            ...
            <div class="flex flex-col gap-4">
                <h3
                    class="font-primary text-sm font-bold tracking-wider uppercase text-white pb-2">
                    GRUPO</h3>
                <ul class="flex flex-col gap-2.5 text-sm text-white/90">
                    <li><a href="{{ route('about') }}" class="hover:text-white/70 transition-colors">Sobre nós</a></li>
                    <li><a href="{{ route('about') }}#certifications" class="hover:text-white/70 transition-colors">Certificações</a></li>
                    <li><a href="{{ route('about') }}#sustainability" class="hover:text-white/70 transition-colors">Sustentabilidade</a></li>
                    <li><a href="{{ route('about') }}#careers" class="hover:text-white/70 transition-colors">Carreiras</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col gap-4">
                <h3
                    ...
                    ÁREAS DE NEGÓCIO</h3>
                <ul class="flex flex-col gap-2.5 text-sm text-white/90">
                    <li><a href="{{ route('panther-mat') }}" class="hover:text-white/70 transition-colors">PantherMAT</a></li>
                    <li><a href="{{ route('panther-build') }}" class="hover:text-white/70 transition-colors">PantherBUILD</a></li>
                    <li><a href="{{ route('panther-oil') }}" class="hover:text-white/70 transition-colors">PantherOIL</a></li>
                    <li><a href="{{ route('enviro') }}" class="hover:text-white/70 transition-colors">Enviro.ao</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col gap-4">
                <h3
                    ...
                    RECURSOS</h3>
                <ul class="flex flex-col gap-2.5 text-sm text-white/90">
                    <li><a href="{{ route('contact') }}" class="hover:text-white/70 transition-colors">Contactos</a></li>
                    <li><a href="{{ route('news') }}" class="hover:text-white/70 transition-colors">Notícias e eventos</a></li>
                    <li><a href="{{ route('contact') }}#partners" class="hover:text-white/70 transition-colors">Parceiros</a></li>
                    <li><a href="{{ route('contact') }}#privacy" class="hover:text-white/70 transition-colors">Política de Privacidade</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <ul class="flex flex-col gap-4 text-sm text-white/90">
                    <li class="flex items-start gap-2.5">
                        <span class="leading-relaxed">Centro Logístico de Talatona Armazém D07 Belas – Talatona Angola</span>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <a href="tel:+244929414778" class="hover:text-white/70 transition-colors font-semibold">+244 929 414 778</a>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <a href="mailto:geral@abpgroup.co.ao" class="hover:text-white/70 transition-colors">geral@abpgroup.co.ao</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div
            ...
            <p>Desenvolvido por <a href="https://xamariz.ao/" target="_blank" class="hover:text-white transition-colors">Xamariz Marketing</a></p>
        </div>
    </footer>
