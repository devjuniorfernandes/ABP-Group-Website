<x-layouts.app>
    ...
    <div class="relative w-full h-[300px] flex items-end pb-10 bg-[#0d1e3d]">
        <div class="absolute inset-0 w-full h-full">
            <img src="https://images.unsplash.com/photo-1518709268805-4e9042af9f23?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-[1000px]">
            <h2 class="font-primary text-4xl md:text-5xl font-extrabold leading-tight mb-8">
                <span class="text-[#3b4b8a]">Construímos soluções</span><br />
                <span class="text-[#3b4b8a]">que impulsionam o crescimento</span><br />
    ...
    <section class="bg-[#3b4b8a] py-0 relative overflow-hidden">
        <div class="container mx-auto max-w-[1200px] px-0 lg:px-6">
            <img src="https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80"
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 max-w-[1000px]">
            <p class="font-secondary text-lg text-gray-800 leading-relaxed mb-8">
                Ao longo da nossa trajectória, consolidámos uma posição de referência através da prestação de serviços
                especializados e da capacidade de responder aos desafios dos sectores mais exigentes. Acreditamos que o
                sucesso sustentável é construído através da qualidade, da confiança e da criação de soluções que geram
                impacto positivo.
            </p>
            <p class="font-secondary text-lg text-gray-800 leading-relaxed">
                Com uma abordagem integrada e uma equipa multidisciplinar, desenvolvemos projectos que combinam
                conhecimento técnico, inovação e excelência operacional. O nosso compromisso é criar valor duradouro
                para clientes, parceiros e comunidades, contribuindo activamente para o desenvolvimento económico e
                social de Angola.
            </p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 bg-[#f5f5f5] min-h-[400px]">
                ...
                <div class="p-10 group hover:bg-[#1c3986] transition-colors duration-300 flex flex-col cursor-default">
                    ...
                    <p class="font-secondary text-base leading-relaxed text-gray-700 group-hover:text-white/90">
                        Contribuir para o desenvolvimento sustentável de Angola através da prestação de serviços
                        especializados e soluções integradas, criando valor para clientes, parceiros e comunidades com
                        elevados padrões de qualidade, segurança e excelência operacional.
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3
                        ...
                        Valor</h3>
                    <p class="font-secondary text-base leading-relaxed text-gray-700 group-hover:text-white/90">
                        Os nossos valores orientam cada decisão e cada projecto que desenvolvemos. Acreditamos na
                        excelência, na integridade, na inovação e na segurança como pilares fundamentais para construir
                        relações de confiança e gerar impacto positivo e sustentável.
                    </p>
                </div>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 max-w-[1000px]">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-12 text-center" id="stats-container">
                <!-- Stat 1 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="150">0</span>+</h3>
                    <p class="font-secondary text-sm text-gray-500">Projetos Concluídos</p>
                </div>
                <!-- Stat 2 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="450">0</span>+</h3>
                    <p class="font-secondary text-sm text-gray-500">Colaboradores Diretos</p>
                </div>
                <!-- Stat 3 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="4">0</span></h3>
                    <p class="font-secondary text-sm text-gray-500">Áreas de Negócio</p>
                </div>
                <!-- Stat 4 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="15">0</span>+</h3>
                    <p class="font-secondary text-sm text-gray-500">Anos de Experiência</p>
                </div>
                <!-- Stat 5 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="18">0</span></h3>
                    <p class="font-secondary text-sm text-gray-500">Províncias Alcançadas</p>
                </div>
                <!-- Stat 6 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="100">0</span>%</h3>
                    <p class="font-secondary text-sm text-gray-500">Cumprimento e Segurança</p>
                </div>
                <!-- Stat 7 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="20">0</span>+</h3>
                    <p class="font-secondary text-sm text-gray-500">Parceiros Estratégicos</p>
                </div>
                <!-- Stat 8 -->
                <div>
                    <h3 class="font-primary text-5xl md:text-6xl text-[#3b4b8a] mb-2 font-light"><span class="counter"
                            data-target="50">0</span>k</h3>
                    <p class="font-secondary text-sm text-gray-500">Horas de Formação</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="relative flex flex-col md:flex-row items-center">
                ...
                <div class="w-full md:w-5/12 flex-shrink-0 relative z-20 pt-8 pb-8 pl-0 md:pl-10 lg:pl-16">
                    ...
                    <div class="bg-[#1c3986] p-4 md:bg-transparent md:p-0">
                        <img src="{{ asset('images/abp_ceo.webp') }}" alt="Mensagem do PCA"
                            class="w-full h-auto object-cover  relative z-20" />
                    </div>
                </div>
                <!-- Text -->
                <div
                    ...
                    <h2 class="font-primary text-3xl md:text-4xl font-extrabold mb-6 leading-tight">
                        Compromisso com a Excelência e Sustentabilidade em Angola
                    </h2>
                    <p class="font-secondary text-base leading-relaxed text-white/90 mb-4">
                        A nossa trajectória é marcada por uma procura incessante de soluções que combinam conhecimento
                        técnico com as melhores práticas internacionais. Ao longo dos anos, o ABP Group solidificou a
                        sua presença através de um crescimento estratégico, apoiado numa equipa extraordinária e na
                        confiança dos nossos parceiros.
                    </p>
                    <p class="font-secondary text-base leading-relaxed text-white/90">
                        O nosso maior orgulho não são apenas os projectos que entregamos, mas o impacto positivo e
                        duradouro que deixamos nas comunidades. Continuaremos a liderar com integridade e inovação para
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-6 max-w-[1100px]">
            <div class="relative w-full aspect-video cursor-pointer group"
                ...
                <video class="w-full h-full object-cover " poster="{{ asset('images/home-hero-new.png') }}" loop>
