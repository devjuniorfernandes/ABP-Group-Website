<div class="fixed rounded-full bottom-6 right-6 z-50 flex flex-col items-center gap-3">
    ...
    <div id="support-options" class="flex rounded-full flex-col items-center gap-3 transition-all duration-300 transform scale-0 translate-y-10 opacity-0 pointer-events-none">
        <!-- Email Button -->
        <a href="mailto:info@abpgroup.co.ao" class="w-12 h-12 rounded-full bg-[#2f498a] hover:bg-[#20376d] text-white flex items-center justify-center shadow-lg transition-transform duration-200 hover:scale-110" aria-label="Enviar Email">
        ...
        <!-- WhatsApp Button -->
        <a href="https://wa.me/244923000000" target="_blank" rel="noopener noreferrer" class="w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white flex items-center justify-center shadow-lg transition-transform duration-200 hover:scale-110" aria-label="Enviar mensagem por WhatsApp">
    ...
    <!-- Main Toggle Button -->
    <button id="support-toggle" class="w-14 h-14 rounded-full bg-[#cc1f26] hover:bg-[#b0161c] text-white flex items-center justify-center shadow-2xl transition-all duration-300 focus:outline-none hover:scale-105" aria-label="Linha de atendimento">
