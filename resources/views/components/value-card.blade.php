...
@php
    $cardClass = [
        'corporate' => 'bg-white text-corporate-primary border border-gray-100 ',
        'enviro' => 'bg-white text-enviro-primary border border-enviro-accent/30 ',
        'oil' => 'bg-white text-oil-primary border border-oil-primary/10 ',
        'mat' => 'bg-white text-mat-primary border border-mat-primary/10 ',
        'build' => 'bg-white text-build-primary border border-build-primary/10 ',
...
<div class="p-8 rounded-2xl  transition-all duration-300 transform hover:-translate-y-1.5 flex flex-col items-start {{ $cardClass }}">
    @if($icon)
